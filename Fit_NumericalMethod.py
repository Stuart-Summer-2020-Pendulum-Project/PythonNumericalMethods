...
if len(args) != num_args:
    print("Expected " + str(num_args) + " command line args, got " + str(len(args)))
    sys.exit(0)
else:
    pass
...
try:
    ...
    print("Failed to read data file. Check that Exp_" + str(exp) + ".csv is in working directory")
    sys.exit(0)
